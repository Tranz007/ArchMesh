...
describe('projectTopology', () => {
  it('aggregates code-level data and integration edges by feature', () => {
    const graph: ArchGraphData = {
      ...
      nodes: [
        { id: 'story-service', label: 'story.ts', kind: 'service', path: 'src/app/story/story.ts', health: 'healthy' },
      ...
      edges: [
        { id: 'e1', source: 'story-service', target: 'stories', relation: 'writes', health: 'healthy' },
        { id: 'e2', source: 'hiring-page', target: 'stories', relation: 'reads', health: 'healthy' },
        { id: 'e3', source: 'story-service', target: 'stripe', relation: 'integrates-with', health: 'healthy' },
      ],
    };
    ...
    expect(topology.edges).toEqual(
      expect.arrayContaining([
        expect.objectContaining({ source: 'feature:story', target: 'stories', relation: 'writes' }),
